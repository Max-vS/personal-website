...
export default function Index() {
    return (
        <>
            <section
                className="h-screen -z-10 flex items-center justify-center bg-secondary-powder text-4xl sm:text-5xl 2xl:text-6xl font-medium text-gray-900 text-center">
                <Typewriter options={{
                    autoStart: true,
                    loop: true
                }} onInit={(typewriter) => {
            ...
            <Element name="projects">
                <Section className="flex items-center">
                    <div className="pt-32">
                        <h1 className="font-semibold text-3xl sm:text-4xl uppercase tracking-widest mb-4 md:mb-10 text-center text-gray-900">Projects</h1>
